...
repl ec with 2 for trim(doctype) $ "INVOICE,STN,RTS,MIS,MISS,STAO,PTAO,PSUEDO-DR,ESTN"
...
*!*	       mrdbf = "prod4win"
*!*	       if mpieces = 0  && rdeguzman 07/06/2020 add checking on inactive dbf for deactivated products.
*!*	          sele inactive
*!*	          locate for cprodno = mcprodno
*!*	          if found()
*!*	             mpieces = inactive.pieces
*!*	             msupplier = inactive.supplier
*!*	             mrdbf = "inactive"
*!*	          endif
*!*	       endif  && rdeguzman
