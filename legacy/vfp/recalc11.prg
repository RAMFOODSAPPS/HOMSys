...
*!*	   USE &TEMPDET ALIAS TEMPDET IN 0 EXCLUSIVE
*ENDIF
temppr_recalc11 = newname("dbf")
sele prod4win
copy to &temppr_recalc11
use &temppr_recalc11 alias temppr_recalc11 in 0 excl
sele temppr_recalc11
appe from inactive
...
set rela to cprodno into temppr_recalc11
*************
*m=messagebox("recalc")
*copy to vicdet stru
*use vicdet in 0
 ...
 *      endif
       *********** 
       ...
       msupplier=temppr_recalc11.supplier
       mcprodno=cprodno
       mclass=class        && class in for rsta
       mclassout=classout
       mpieces=temppr_recalc11.pieces
       muc=uc
